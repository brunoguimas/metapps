...
export default function Login() {
  ...
  return (
    <div style={split}>
      ...
      {/* Painel esquerdo — idêntico ao Register */}
      <div style={leftPanel}>
...
const forgotLnk = { fontSize:12.5, fontWeight:600, color:'#9ab4ff', textDecoration:'none', transition:'color .15s' }
...
const btnGoogle  = {
  width:'100%', padding:'13px', borderRadius:10, border:'1.5px solid rgba(255,255,255,0.1)',
  background:'rgba(255,255,255,0.05)', fontFamily:"'Inter',-apple-system,sans-serif", fontSize:14,
  fontWeight:600, color:'#f5f4ff', cursor:'pointer', display:'flex', alignItems:'center',
...
const orLine     = { flex:1, height:1, background:'rgba(255,255,255,0.1)' }
const orText     = { fontSize:12, color:'rgba(245,244,255,0.45)', fontWeight:500, textTransform:'uppercase', letterSpacing:'0.5px' }
