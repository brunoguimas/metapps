...
type GoalRepository interface {
	Create(c context.Context, g *models.Goal) (*models.Goal, error)
	ListByUserID(c context.Context, userID uuid.UUID) ([]*models.Goal, error)
	GetByID(c context.Context, userID, goalID uuid.UUID) (*models.Goal, error)
	Update(c context.Context, g *models.Goal) error
...
func (r *goalRepository) Create(c context.Context, g *models.Goal) (*models.Goal, error) {
...
func (r *goalRepository) ListByUserID(c context.Context, userID uuid.UUID) ([]*models.Goal, error) {
	...
	items := make([]*models.Goal, 0, len(goals))
	for _, g := range goals {
...
func (r *goalRepository) GetByID(c context.Context, userID, goalID uuid.UUID) (*models.Goal, error) {
...
func (r *goalRepository) Update(c context.Context, g *models.Goal) error {
...
func mapGoal(g db.Goal) *models.Goal {
