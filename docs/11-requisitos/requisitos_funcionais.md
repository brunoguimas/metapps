...
> O sistema deve permitir que o usuário possua mais de uma meta.

### RF07 - Atividades diárias

> O sistema deve disponibilizar atividades diárias para o usuário que se moldam a necessidade do mesmo:
> - Essas atividades podem ser: quiz, produção textual, exercício de alternativa simples entre outros;
> - Essas atividades devem acompanhar o nível de aprendizado do usuário, assim mudando a dificuldade conforme o necessário.

### RF08 - Feedback

> O sistema deve retornar um feedback sobre o desempenho do usuário na atividade.

### RF09 - Personalização com AI

> O sistema deve preparar atividades e feedbacks para o usuário personalizados por uma IA com base no histórico do usuário.
